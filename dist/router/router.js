...
const cart_route_1 = __importDefault(require("../app/modules/cart/cart.route"));
...
allRouters.use("/cart", cart_route_1.default);
allRouters.use("/auth", auth_route_1.default);
allRouters.use("/order", order_route_1.default);
