...
AuthRoute.post("/create-service-provider", (0, auth_1.default)(["admin", "super_admin"]), (0, validateRequest_1.default)(user_schema_1.CreateServiceProviderSchema), user_control_1.default.createServiceProvider);
